...
public class ExactDateScheduler {
    ...
    public void scheduleDaily(LocalDateTime startDate, LocalDateTime endDate) {
        ...
        // So if we try to start scheduler for 7 days but first 3 days are already in the past, we will run the
        // remaining 4 tasks.
        ...
        poolScheduler.schedule(() -> scheduleDaily(startDate, endDate),
            scheduledTime.plus(1, ChronoUnit.DAYS).minus(5, ChronoUnit.MINUTES));
    }
