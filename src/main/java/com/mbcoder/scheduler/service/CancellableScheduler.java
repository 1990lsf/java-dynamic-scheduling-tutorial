...
/**
 * Alternative version for DynamicScheduler This one should support everything the basic dynamic scheduler does, and on
 * top of it, you can cancel and re-activate the scheduler.
 *
 * Also nothing here is set in stone, you can change the implementation depending on your needs, this is just an example
 * about how to cancel and re-activate
 */
...
public class CancellableScheduler implements SchedulingConfigurer {
 ...
 // Or cron way, you can also get the expression from DB or somewhere else just like we did in DynamicScheduler
